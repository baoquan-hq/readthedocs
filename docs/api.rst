...
假定payload如下所示::

    {
        "title": "这是xx合同的标题",
         ...
         "remark": "这是xx合同的备注信息",
          "users": {
             "15811111111":"personal"
             "15822222222":"persoanl"
...
type               String字符串，当前签署人类型            必选,（可选"personal"，"enterprise"）
=================  ======================================= ================
...
type               String字符串，签署类型                     必选,（可选"personal"，"enterprise"）
...
type                 String字符串，签署人类型             必选,（可选"personal"，"enterprise"）
=================  ======================================= ================
phone 为合同组的创建人
假定payload如下所示::
